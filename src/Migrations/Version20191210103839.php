 ...
 */
final class Version20191210103839 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD commented_at DATETIME DEFAULT NULL, CHANGE commented_by_id commented_by_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP commented_at, CHANGE commented_by_id commented_by_id INT DEFAULT NULL');
