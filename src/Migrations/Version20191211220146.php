 ...
 */
final class Version20191211220146 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE profile_img_id profile_img_id INT DEFAULT NULL, CHANGE roles roles VARCHAR(255) DEFAULT NULL, CHANGE username username VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649A840F832 FOREIGN KEY (profile_img_id) REFERENCES image (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE comment CHANGE commented_by_id commented_by_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart CHANGE added_by_id added_by_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL, CHANGE added_at added_at DATETIME DEFAULT \'current_timestamp()\', CHANGE amount amount INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D649A840F832');
        $this->addSql('ALTER TABLE user CHANGE profile_img_id profile_img_id INT DEFAULT NULL, CHANGE roles roles VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE username username VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649A840F832 FOREIGN KEY (profile_img_id) REFERENCES image (id)');
    }
}
