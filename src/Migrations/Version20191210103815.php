 ...
 */
final class Version20191210103815 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP product_id, DROP commented_at, CHANGE commented_by_id commented_by_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD product_id INT DEFAULT NULL, ADD commented_at DATE DEFAULT \'current_timestamp()\' NOT NULL, CHANGE commented_by_id commented_by_id INT DEFAULT NULL');
