 ...
 */
final class Version20191210104016 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD product_id INT DEFAULT NULL, CHANGE commented_by_id commented_by_id INT DEFAULT NULL, CHANGE commented_at commented_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526C4584665A FOREIGN KEY (product_id) REFERENCES food (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP product_id, CHANGE commented_by_id commented_by_id INT DEFAULT NULL, CHANGE commented_at commented_at DATETIME DEFAULT \'current_timestamp()\'');
