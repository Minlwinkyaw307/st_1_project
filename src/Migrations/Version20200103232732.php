 ...
 */
final class Version20200103232732 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD status TINYINT(1) DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL, ADD rate INT DEFAULT NULL, ADD ip VARCHAR(30) DEFAULT NULL, CHANGE commented_by_id commented_by_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP status, DROP updated_at, DROP rate, DROP ip, CHANGE commented_by_id commented_by_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL');
